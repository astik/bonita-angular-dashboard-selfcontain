...
appModule.controller('dashboardController', 
	['$scope', '$cookies', '$modal', 'BonitaSession', 'User', 'HumanTask', 'ArchivedHumanTask', 'ProcessDefinition', 'ProcessInstance', 'ArchivedProcessInstance', 
	function ($scope, $cookies, $modal, BonitaSession, User, HumanTask, ArchivedHumanTask, ProcessDefinition, ProcessInstance, ArchivedProcessInstance) {
...
// User apps
appModule.directive("userApps", [function() {
	return {
		restrict: 'E',
...
appModule.directive("userAvailableTasks", [function() {
	return {
		restrict: 'E',
...
// User's open cases
appModule.directive("userOpenCases", [function() {
	return {
		restrict: 'E',
